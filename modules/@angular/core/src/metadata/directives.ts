...
import {TypeDecorator, makeDecorator2} from '../util/decorators';
 ...
 * @Annotation
 */
export const Directive: DirectiveMetadataFactory = <DirectiveMetadataFactory>makeDecorator2({
  selector: undefined,
  inputs: undefined,
  outputs: undefined,
  host: undefined,
 ...
 * @Annotation
 */
export const Component: ComponentMetadataFactory = <ComponentMetadataFactory>makeDecorator2(
    {
      selector: undefined,
      inputs: undefined,
      outputs: undefined,
